...
##Be aware!! This simple steps - take more than a hour to run!
...
```{r recreateTermDocumentMatrix, collapse=lapse = TRUE}
tmd <- TermDocumentMatrix(theCorpus)
#Show the frequent terms
findFreqTerms(tmd, lowfreq = 100)
